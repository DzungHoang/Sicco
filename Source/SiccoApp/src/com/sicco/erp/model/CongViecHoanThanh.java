...
public class CongViecHoanThanh {
	...
	public CongViecHoanThanh(String id, String tencongviec, String hancuoi) {
		this.id = id;
		this.tencongviec = tencongviec;
		this.hancuoi = hancuoi;
	}

	public CongViecHoanThanh(String id, String tencongviec, String ngaybatdau,
			String tinhtrang, String tiendo, String nguoithuchien,
			String phongban, String loaicongviec, String hancuoi, String duan,
			String mucuutien, String nguoiduocxem, String nguoigiao,
			String mota, String tonghopbaocao, String tepdinhkem, String url,
			ArrayList<ThaoLuan> thaoluan) {
		this.id = id;
		this.tencongviec = tencongviec;
